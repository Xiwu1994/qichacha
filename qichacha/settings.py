...
DOWNLOADER_MIDDLEWARES = {
    'qichacha.middlewares.RandomUserAgent': 1,
    # 'qichacha.middlewares.ProxyMiddleware': 100, # 动态IP
...
ITEM_PIPELINES = {
   ...
   'qichacha.pipelines.MysqlPipeline': 1,
}
...
# mysql_port = "3306"
# mysql_user = "ynapp"
# mysql_password = "ynapppass"
# mysql_database = "beeper2_bi"


PROXIES = [
    {'ip_port': '110.87.25.223:6666', 'user_pass': ''},
    {'ip_port': '116.231.88.54:8060', 'user_pass': ''},
    {'ip_port': '121.224.9.177:8060', 'user_pass': ''},
    {'ip_port': '27.204.85.159:61234', 'user_pass': ''},
    {'ip_port': '222.132.65.91:8908', 'user_pass': ''},
]